    ...
    <>
      ...
      <Blog>
        <BlogHeader
          ...
          intro={blog.intro}
        />
        <LesserKnownIcelandIndex locations={blog.content.locations} regions={blog.content.regions} />
      </Blog>
    </>
  )
}
...
export const getStaticProps = async () => {
  ...
  const documents = await collection.find({ slug: 'lesser-known-iceland' }).toArray()
