  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://tijsvl.net/img/og_default.jpg"
        />
        <meta
          name="twitter:image"
          content="https://tijsvl.net/img/og_default.jpg"
        />
        <link rel="canonical" href="https://tijsvl.net/copyright" />
        <meta property="og:url" content="https://tijsvl.net/copyright" />
        <meta name="twitter:url" content="https://tijsvl.net/copyright" />
      </Head>
      <section>
        <h1>Copyright</h1>
        ...
        <div className={classes.copyright}>
          <div className={classes.note}>
            ...
            <a
              href="copyright_until_june_10_2021.txt"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <p>
              I hold all copyrights to all photos on this website unless
              mentioned otherwise. Photos may only be used with written consent.
              Exceptions may be listed below.
            </p>
          </div>
          ...
          <p>
            ...
            and:
            <br />
            - Include details such as the name of the campaign, estimated reach,
            what you&apos;re promoting, etc.
            <br />
          ...
          <p>
            - You may use my photo on your social media outlets, but you MUST
            visibly credit me both in text and tag using{' '}
            ...
            <br />
            - You may share my work using the &apos;share&apos; functions
            provided by Instagram, Facebook and/or Twitter.
            <br />
            - You may NOT use any photo to promote products and/or services
          ...
          <p>
            ...
            <a
              href="https://unsplash.com/@tijsvl"
              target="_blank"
              rel="noreferrer"
            >
              my profile
            ...
            ), Getty Images and other platforms are exempt from all mentioned
            above. Terms & Conditions of the respective platforms apply instead.
          </p>
