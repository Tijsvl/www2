  ...
  return (
    <React.Fragment>
      <div suppressHydrationWarning={true}>
        <Head>
          <title>
            {date(gallery.date, 'short-not-year')} - {gallery.artist} @{' '}
            {gallery.city}, {gallery.country} | @tijsvl
          </title>
        </Head>
              ...
              <React.Fragment key={photo.image}>
                ...
                >
                  <img
                    ...
                    data-key={idx}
                    src={
                      'https://tijsvl.net/Qlibpk7E/approval/' +
                      gallery.date +
                      '-' +
                      gallery.slug +
                      '/' +
